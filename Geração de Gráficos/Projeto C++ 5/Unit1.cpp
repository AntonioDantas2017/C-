...
if(StrToInt(txtnumero->Text) >= 0)
{
        ...
        txtnumero->SetFocus();
                ...
                ShowMessage("Você só pode inserir até 24 alunos");
        }
}else{
        if(linha > 0)
        {
                ...
                ShowMessage("Você deve cadastrar pelo menos um aluno");
        }
}
}else{
        ...
        txtnumero->SetFocus();
        ShowMessage("Preencha o número e a nota do aluno");
}
}        
}
//---------------------------------------------------------------------------
...
if(*x == 13)
   txtnumero->SetFocus();
        ...
        {
                ShowMessage("É permitido somente número");
                *x = 0;
        }
}         
}
